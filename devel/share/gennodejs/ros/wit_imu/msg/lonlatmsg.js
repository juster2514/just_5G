...
class lonlatmsg {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type lonlatmsg
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type lonlatmsg
    let len;
    let data = new lonlatmsg(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new lonlatmsg(null);
