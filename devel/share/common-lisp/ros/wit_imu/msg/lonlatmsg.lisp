...
;//! \htmlinclude lonlatmsg.msg.html

(cl:defclass <lonlatmsg> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass lonlatmsg (<lonlatmsg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <lonlatmsg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'lonlatmsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wit_imu-msg:<lonlatmsg> is deprecated: use wit_imu-msg:lonlatmsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <lonlatmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wit_imu-msg:header-val is deprecated.  Use wit_imu-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'orientation_x-val :lambda-list '(m))
(cl:defmethod orientation_x-val ((m <lonlatmsg>))
...
(cl:defmethod orientation_y-val ((m <lonlatmsg>))
...
(cl:defmethod orientation_z-val ((m <lonlatmsg>))
...
(cl:defmethod orientation_w-val ((m <lonlatmsg>))
...
(cl:defmethod angular_velocity_x-val ((m <lonlatmsg>))
...
(cl:defmethod angular_velocity_y-val ((m <lonlatmsg>))
...
(cl:defmethod angular_velocity_z-val ((m <lonlatmsg>))
...
(cl:defmethod linear_acceleration_x-val ((m <lonlatmsg>))
...
(cl:defmethod linear_acceleration_y-val ((m <lonlatmsg>))
...
(cl:defmethod linear_acceleration_z-val ((m <lonlatmsg>))
...
(cl:defmethod lon-val ((m <lonlatmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wit_imu-msg:lon-val is deprecated.  Use wit_imu-msg:lon instead.")
  (lon m))

(cl:ensure-generic-function 'lat-val :lambda-list '(m))
(cl:defmethod lat-val ((m <lonlatmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wit_imu-msg:lat-val is deprecated.  Use wit_imu-msg:lat instead.")
  (lat m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <lonlatmsg>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <lonlatmsg>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lonlatmsg>)))
  "Returns string type for a message object of type '<lonlatmsg>"
  "wit_imu/lonlatmsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lonlatmsg)))
  "Returns string type for a message object of type 'lonlatmsg"
  "wit_imu/lonlatmsg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<lonlatmsg>)))
  "Returns md5sum for a message object of type '<lonlatmsg>"
  "e878f84d074ad390c7bc000ad671f338")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'lonlatmsg)))
  "Returns md5sum for a message object of type 'lonlatmsg"
  "e878f84d074ad390c7bc000ad671f338")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<lonlatmsg>)))
  "Returns full string definition for message of type '<lonlatmsg>"
  (cl:format cl:nil "Header header ~%~%float64 orientation_x~%float64 orientation_y~%float64 orientation_z~%float64 orientation_w~%~%float64 angular_velocity_x~%float64 angular_velocity_y~%float64 angular_velocity_z~%~%float64 linear_acceleration_x~%float64 linear_acceleration_y~%float64 linear_acceleration_z~%~%float64 lon~%float64 lat~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'lonlatmsg)))
  "Returns full string definition for message of type 'lonlatmsg"
  (cl:format cl:nil "Header header ~%~%float64 orientation_x~%float64 orientation_y~%float64 orientation_z~%float64 orientation_w~%~%float64 angular_velocity_x~%float64 angular_velocity_y~%float64 angular_velocity_z~%~%float64 linear_acceleration_x~%float64 linear_acceleration_y~%float64 linear_acceleration_z~%~%float64 lon~%float64 lat~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <lonlatmsg>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <lonlatmsg>))
