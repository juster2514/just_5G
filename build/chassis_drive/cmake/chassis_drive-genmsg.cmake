...
message(STATUS "chassis_drive: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ichassis_drive:/home/ljj/just_5g_ws/src/chassis_drive/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ljj/just_5g_ws/src/chassis_drive/msg/Drive.msg" NAME_WE)
add_custom_target(_chassis_drive_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "chassis_drive" "/home/ljj/just_5g_ws/src/chassis_drive/msg/Drive.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(chassis_drive
  "/home/ljj/just_5g_ws/src/chassis_drive/msg/Drive.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/chassis_drive)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/chassis_drive\")")
  # install generated code
  install(
